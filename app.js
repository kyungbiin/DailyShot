...
const STORE_DATA = [
  {
    ...
    photos: ['https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=300&fit=crop'],
    top: 28, left: 18
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&h=300&fit=crop'],
    top: 45, left: 24
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1550966871-3ed3cdb51f3a?w=400&h=300&fit=crop'],
    top: 22, left: 72
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1550966871-3ed3cdb51f3a?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=400&h=300&fit=crop'],
    top: 50, left: 70
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1543007630-9710e4a00a20?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1474722883778-792e7990302f?w=400&h=300&fit=crop'],
    top: 55, left: 15
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1485686531765-ba63b07845a7?w=400&h=300&fit=crop'],
    top: 35, left: 9
  },
  {
    ...
    hours: '화 - 일 오후 12:00 ~ 오후 10:00',
    photos: ['https://images.unsplash.com/photo-1559339352-11d035aa65de?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop'],
    top: 33, left: 17
  },
  {
    ...
    hours: '월 - 일 오전 11:00 ~ 오후 11:00',
    photos: ['https://images.unsplash.com/photo-1544025162-d76694265947?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1558030006-450675393462?w=400&h=300&fit=crop'],
    top: 20, left: 78
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1578474846511-04ba529f0b88?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1525268323446-0505b6fe7778?w=400&h=300&fit=crop'],
    top: 30, left: 55
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1552566626-52f8b828add9?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?w=400&h=300&fit=crop'],
    top: 38, left: 82
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400&h=300&fit=crop'],
    top: 47, left: 40
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1600891964092-4316c288032e?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1560624052-449f5ddf0c31?w=400&h=300&fit=crop'],
    top: 53, left: 35
  },
  {
    ...
    hours: '화 - 일 오후 12:00 ~ 오후 10:00',
    photos: ['https://images.unsplash.com/photo-1592861956120-e524fc739696?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1560624052-449f5ddf0c31?w=400&h=300&fit=crop'],
    top: 60, left: 52
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1528823872057-9c018a7a7553?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=400&h=300&fit=crop'],
    top: 62, left: 22
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=400&h=300&fit=crop'],
    top: 68, left: 30
  },
  {
    ...
    hours: '화 - 일 오후 12:00 ~ 오후 11:00',
    photos: ['https://images.unsplash.com/photo-1549488344-cbb6c34cf08b?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop'],
    top: 42, left: 50
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?w=400&h=300&fit=crop'],
    top: 75, left: 62
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&h=300&fit=crop'],
    top: 15, left: 50
  },
  {
    ...
    hours: '화 - 일 오후 12:00 ~ 오후 10:00',
    photos: ['https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=400&h=300&fit=crop'],
    top: 85, left: 40
  },
  {
    ...
    photos: ['https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=300&fit=crop', 'https://images.unsplash.com/photo-1543007630-9710e4a00a20?w=400&h=300&fit=crop'],
    top: 22, left: 17
  },
];
  ...
  return `
    <div class="store-card" data-id="${store.id}">
      ...
      <div class="store-photos">
        <div class="store-photos__img" style="background-image:url('${store.photos[0]}');background-size:cover;background-position:center"></div>
        <div class="store-photos__img" style="background-image:url('${store.photos[1]}');background-size:cover;background-position:center"></div>
      </div>
    </div>`;
}
...
const DETAIL_EXTRA = {
  ...
  menu: {
    recommended: [
      { name: '바질크림 파스타', desc: '신선한 바질페스토 크림파스타', price: '25,000원', img: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=200&h=200&fit=crop' },
      { name: '와인 무제한 1인', desc: '2시간 동안 다양한 보틀와인 무제한 이용', price: '30,000원', img: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=200&h=200&fit=crop' },
      { name: '치즈할 라구토마토 파스타', desc: '2시간 동안 다양한 보틀와인 무제한 이용', price: '25,000원', img: 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=200&h=200&fit=crop' },
    ],
  },
  ai: {
    score: 93,
...
function openDetailPage(store) {
  ...
  detailGallery.innerHTML = `
    <div class="detail-gallery__main" style="background-image:url('${store.photos[0]}');background-size:cover;background-position:center"></div>
    <div class="detail-gallery__thumb" style="background-image:url('${store.photos[1]}');background-size:cover;background-position:center"></div>
    <div class="detail-gallery__thumb" style="background-image:url('${store.photos[0]}');background-size:cover;background-position:center;filter:brightness(0.8)"></div>`;
  ...
  document.getElementById('section-menu').innerHTML = `
    ...
    <div class="menu-board">
      <div class="menu-board__img" style="background-image:url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=400&fit=crop');background-size:cover;background-position:center"></div>
      <div class="menu-board__img" style="background-image:url('https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=400&h=400&fit=crop');background-size:cover;background-position:center"></div>
      <div class="menu-board__img" style="background-image:url('https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=400&fit=crop');background-size:cover;background-position:center"></div>
    </div>
    <div style="font-size:14px;font-weight:700;margin-bottom:12px;color:#222">추천 메뉴</div>
    ${menu.recommended.map(item => `
      <div class="menu-item">
        <div class="menu-item__img" style="background-image:url('${item.img}');background-size:cover;background-position:center"></div>
  ...
  document.getElementById('section-review').innerHTML = `
    ...
    <div class="review-card">
      ...
      <div class="review-photos">
        <div class="review-photos__img" style="background-image:url('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop');background-size:cover;background-position:center"></div>
        <div class="review-photos__img" style="background-image:url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=300&fit=crop');background-size:cover;background-position:center"></div>
      </div>
    </div>
    <button class="more-btn">더보기</button>`;
