  ...
  return `
    <div class="store-card" data-id="${store.id}">
      ...
      <div class="store-photos">
        <div class="store-photos__img" style="background:${store.photos[0]}"></div>
        <div class="store-photos__img" style="background:${store.photos[1]}"></div>
      </div>
    </div>`;
}
...
const DETAIL_EXTRA = {
  ...
  menu: {
    recommended: [
      { name: '바질크림 파스타', desc: '신선한 바질페스토 크림파스타', price: '25,000원' },
      { name: '와인 무제한 1인', desc: '2시간 동안 다양한 보틀와인 무제한 이용', price: '30,000원' },
      { name: '치즈할 라구토마토 파스타', desc: '2시간 동안 다양한 보틀와인 무제한 이용', price: '25,000원' },
    ],
  },
  ai: {
    score: 93,
...
function openDetailPage(store) {
  ...
  detailGallery.innerHTML = `
    <div class="detail-gallery__main" style="background:${store.photos[0]}"></div>
    <div class="detail-gallery__thumb" style="background:${store.photos[1]}"></div>
    <div class="detail-gallery__thumb" style="background:${store.photos[0]};filter:brightness(0.8)"></div>`;
  ...
  document.getElementById('section-menu').innerHTML = `
    ...
    <div class="menu-board">
      <div class="menu-board__img"></div>
      <div class="menu-board__img" style="background:#DDD8D0"></div>
      <div class="menu-board__img" style="background:#D0CCC4"></div>
    </div>
  ...
  document.getElementById('section-review').innerHTML = `
    ...
    <div class="review-card">
      ...
      <div class="review-photos">
        <div class="review-photos__img"></div>
        <div class="review-photos__img" style="background:#D5D0CA"></div>
      </div>
    </div>
    <button class="more-btn">더보기</button>`;
